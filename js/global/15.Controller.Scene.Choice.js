...
(function ($, ns, controller, tween) {
  ...
  controller.scenechoice = function (params) {
    var event = ns.EventHandlerInstance,
      ...
      shareBtnEl,
      sparkleEl,
      wrongChoiceContentCopyEl,
      wrongChoiceContentBadgeEl,
      ease = Expo.easeInOut,
      speed = 0.5,
      lang = ns.lang,
      ...
      buildScreen = function () {
        ...
        wrongChoiceContentCopyEl = wrongChoiceEl.find(
          ".wrong-choice-content-copy"
        );
        wrongChoiceContentBadgeEl = wrongChoiceEl.find(
          ".wrong-choice-content-badge"
        );
      ...
      preloadSceneThreesixty = function () {
        controller.getAssets(
          controller.getData("scene_" + scene + "_threesixty").assets[
            "threesixty"
          ],
          {}
        );
      ...
      swipeWrongChoiceElements = function () {
        ...
        tween.to(wrongChoiceContentCopyEl[0], speed * 2, {
          left: "-500",
          ease: ease,
        });
        tween.to(wrongChoiceContentBadgeEl[0], speed * 2, {
          left: "0",
          ease: ease,
        });
      },
