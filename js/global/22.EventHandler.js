...
(function ($, ns)
{
    ...
    preloaderStart = function ()
    {
		...
		setUpMoviePlay = function (scene, video)
		{
			...
			switch (scene)
			{
				case 1: dmaf.registerObject('sceneOneIntro', video); break;
				case 2: dmaf.registerObject('sceneTwoIntro', video); break;
				case 3: dmaf.registerObject('sceneThreeIntro', video); break;
			}
		},
		...
		setUpMovieEnd = function (scene, video)
		{
			...
			switch (scene)
			{
				case 1: dmaf.unregisterObject('sceneOneIntro'); break;
				case 2: dmaf.unregisterObject('sceneTwoIntro'); break;
				case 3: dmaf.unregisterObject('sceneThreeIntro'); break;
			}
		},
		...
		choicePageLoad = function (scene)
		{
			...
			switch (scene)
			{
				case 1: dmaf.tell('showSceneOneDescisionPoint'); break;
				case 2: dmaf.tell('showSceneTwoDescisionPoint'); break;
				case 3: dmaf.tell('showSceneThreeDescisionPoint'); break;
			}
		},
		...
		choiceShowWrongChoice = function (scene)
		{
			...
			switch (scene)
			{
				case 1: dmaf.tell('sceneOneFailPage'); break;
				case 2: dmaf.tell('sceneTwoFailPage'); break;
				case 3: dmaf.tell('sceneThreeFailPage'); break;
			}
		},
        ...
        {
        	trackEvent('', 'decision', 'scene' + scene + '/' + platform + '/' + shareTypes[platform]);
        },
	    ...
	    choiceResolutionPlay = function (scene, video)
	    {
	    	...
	    	switch (scene)
	    	{
	    		case 1: dmaf.registerObject('sceneOneTransition', video); break;
	    		case 2: dmaf.registerObject('sceneTwoTransition', video); break;
	    		case 3: dmaf.registerObject('sceneThreeTransition', video); break;
	    	}
	    },
		...
		choiceResolutionEnd = function (scene, video)
		{
			switch (scene)
			{
				case 1: dmaf.unregisterObject('sceneOneTransition'); break;
				case 2: dmaf.unregisterObject('sceneTwoTransition'); break;
				case 3: dmaf.unregisterObject('sceneThreeTransition'); break;
			}
		},
		...
		threeSixtyShowIntro = function (scene)
		{
			...
			switch (scene)
			{
				case 1: dmaf.tell('startSceneOne360Pan'); break;
				case 2: dmaf.tell('startSceneTwo360Pan'); break;
				case 3: dmaf.tell('startSceneThree360Pan'); break;
			}
		},
		...
		threeSixtyShowHotspots = function (scene)
		{
			switch (scene)
			{
				case 1: dmaf.tell('showSceneOne360'); break;
				case 2: dmaf.tell('showSceneTwo360'); break;
				case 3: dmaf.tell('showSceneThree360'); break;
			}
		},
	    ...
	    prefixCategory = function (category)
	    {
	    	...
	    	var prefixedCategory = splitLocale[0].toLowerCase() + '/' + splitLocale[1].toLowerCase() + '/nfs_rivals/cross_the_line';
